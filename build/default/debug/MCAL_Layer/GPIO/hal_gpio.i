...
std_ReturnType gpio_pin_direction_intiailize(const pin_config_t *pin_config_t){
    ...
    if(pin_config_t == ((void*)0)){
     ret = (std_ReturnType) 0x00;
    }
    else{
        switch(pin_config_t->direction){
            case GPIO_DIRECTION_OUTPUT:
                (*tris_register[pin_config_t->port] &= ~((uint8)1 << pin_config_t->pin));
                break;
...
std_ReturnType gpio_pin_direction_status(const pin_config_t *pin_config_t ,direction_t *dic_status ){
    std_ReturnType ret = (std_ReturnType) 0x01;
    if(pin_config_t == ((void*)0) || dic_status == ((void*)0)){
     ret = (std_ReturnType) 0x00;
    }
    else{
       *dic_status = ((*tris_register[pin_config_t->port] >> pin_config_t->pin) & (uint8)1);
    }
...
std_ReturnType gpio_pin_write_logic(const pin_config_t *pin_config_t , logic_t logic){
    ...
    if(pin_config_t == ((void*)0) ){
     ret = (std_ReturnType) 0x00;
        ...
        switch(logic){
            case GPIO_LOW :
                (*lat_register[pin_config_t->port] &= ~((uint8)1 << pin_config_t->pin));
                break;
            case GPIO_HIGH:
                (*lat_register[pin_config_t->port] |= ((uint8)1 << pin_config_t->pin));
                break;
...
std_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config_t , logic_t *logic){
    ...
    if(pin_config_t == ((void*)0)){
     ret = (std_ReturnType) 0x00;
       ...
       *logic = ((*port_register[pin_config_t->port] >> pin_config_t->pin) & (uint8)1);
    }
