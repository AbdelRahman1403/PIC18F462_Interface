# 1 "ECU_Layer/7_segment/ecu_7_segment.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_Layer/7_segment/ecu_7_segment.c" 2
# 1 "ECU_Layer/7_segment/ecu_7_segment.h" 1
# 12 "ECU_Layer/7_segment/ecu_7_segment.h"
...
# 11 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 11 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 11 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../device_config.h"
...
# 11 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 71 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 12 "ECU_Layer/7_segment/ecu_7_segment.h" 2
# 22 "ECU_Layer/7_segment/ecu_7_segment.h"
typedef enum{
...
std_ReturnType seven_segment_initialize(const segment_t *segment){
    ...
    if(segment == ((void*)0)){
       ...
       ret = gpio_pin_intiailize(&(segment->segment_pins[0]));
       ret = gpio_pin_intiailize(&(segment->segment_pins[1]));
       ret = gpio_pin_intiailize(&(segment->segment_pins[2]));
       ret = gpio_pin_intiailize(&(segment->segment_pins[3]));
    }
    return ret;
}
...
std_ReturnType seven_segment_write_number(const segment_t *segment , uint8 number){
    ...
    if((segment == ((void*)0)) && (number > 9)){
        ...
        gpio_pin_write_logic(&(segment->segment_pins[0]) , number & 0x01);
