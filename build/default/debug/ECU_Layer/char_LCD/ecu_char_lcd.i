...
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
...
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../device_config.h"
...
# 11 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 71 "ECU_Layer/char_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 47 "ECU_Layer/char_LCD/ecu_char_lcd.h"
typedef struct{
...
std_ReturnType lcd_chr_8bit_send_custom_chr(const lcd_8bit_t *lcd , uint8 row,
                                            uint8 column ,const uint8 chr[] , uint8 mem_pos);
# 2 "ECU_Layer/char_LCD/ecu_char_lcd.c" 2
...
std_ReturnType lcd_chr_4bit_intialize(const lcd_4bit_t *lcd){
    ...
    if(lcd == ((void*)0)){
        ...
        for(l_pin_lcd_counter = 0 ; l_pin_lcd_counter < 4 ; l_pin_lcd_counter++){
        ret = gpio_pin_intiailize(&(lcd->lcd_pin[l_pin_lcd_counter]));
        }
        _delay((unsigned long)((20)*(8000000UL/4000.0)));
        ret |= lcd_chr_4bit_send_command(lcd , 0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        ret |= lcd_chr_4bit_send_command(lcd , 0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        ret |= lcd_chr_4bit_send_command(lcd , 0x38);

        lcd_chr_4bit_send_command(lcd , 0x01);
        lcd_chr_4bit_send_command(lcd , 0x02);
        lcd_chr_4bit_send_command(lcd , 0x06);
        lcd_chr_4bit_send_command(lcd , 0x0D);
        lcd_chr_4bit_send_command(lcd , 0x28);
...
std_ReturnType lcd_chr_8bit_intialize(const lcd_8bit_t *lcd){
    ...
    if(lcd == ((void*)0)){
        ...
        ret = gpio_pin_intiailize(&(lcd->en_pin));
        ret = gpio_pin_intiailize(&(lcd->rs_pin));
        for(l_pin_lcd_counter = 0 ; l_pin_lcd_counter < 8 ; l_pin_lcd_counter++){
        ret = gpio_pin_intiailize(&(lcd->lcd_pin[l_pin_lcd_counter]));
        }
        _delay((unsigned long)((20)*(8000000UL/4000.0)));
        ret |= lcd_chr_8bit_send_command(lcd , 0x38);
        _delay((unsigned long)((5)*(8000000UL/4000.0)));
        ret |= lcd_chr_8bit_send_command(lcd , 0x38);
        _delay((unsigned long)((150)*(8000000UL/4000000.0)));
        ret |= lcd_chr_8bit_send_command(lcd , 0x38);

        lcd_chr_8bit_send_command(lcd , 0x01);
        lcd_chr_8bit_send_command(lcd , 0x02);
        lcd_chr_8bit_send_command(lcd , 0x06);
        lcd_chr_8bit_send_command(lcd , 0x0C);
        lcd_chr_8bit_send_command(lcd , 0x38);
...
static std_ReturnType lcd_chr_8bit_set_cursor(const lcd_8bit_t *lcd , uint8 row , uint8 column){
    ...
    if(lcd == ((void*)0) || row > 5){
        ...
        column--;
        switch(row){
            case 1: lcd_chr_8bit_send_command(lcd , (0x80 + column)); break;
            case 2: lcd_chr_8bit_send_command(lcd , (0xC0 + column)); break;
            case 3: lcd_chr_8bit_send_command(lcd , (0x94 + column)); break;
            case 4: lcd_chr_8bit_send_command(lcd , (0xd4 + column)); break;
            deafult: ;
        }
    }
    return ret;
...
static std_ReturnType lcd_chr_4bit_set_cursor(const lcd_4bit_t *lcd , uint8 row , uint8 column){
    ...
    if(lcd == ((void*)0) || row > 5){
        ...
        column--;
        switch(row){
            case 1: lcd_chr_4bit_send_command(lcd , (0x80 + column)); break;
            case 2: lcd_chr_4bit_send_command(lcd , (0xC0 + column)); break;
            case 3: lcd_chr_4bit_send_command(lcd , (0x94 + column)); break;
            case 4: lcd_chr_4bit_send_command(lcd , (0xd4 + column)); break;
            deafult: ;
        }
    }
    return ret;
